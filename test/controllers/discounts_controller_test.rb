...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount_amount: @discount.discount_amount, discount_percent: @discount.discount_percent, end: @discount.end, name: @discount.name, product_id: @discount.product_id, start: @discount.start, unit: @discount.unit } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount_amount: @discount.discount_amount, discount_percent: @discount.discount_percent, end: @discount.end, name: @discount.name, product_id: @discount.product_id, start: @discount.start, unit: @discount.unit } }
